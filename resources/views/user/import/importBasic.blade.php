...
<div class="row justify-content-md-center mb-2">
    ...
    <div class="alert alert-warning alert-dismissible fade show" role="alert">
        <strong>Importante!</strong> Seccion para subir las remesas ya sea de educacion basica o JEF segun sea el caso,
        asi como las respectivas actualizaciones de los estados de entrega
...
<div class="row justify-content-md-center">
    ...
    <div class="col-7">
        <div class="card">
            <h5 class="card-header">Importar entregas de educacion basica</h5>
